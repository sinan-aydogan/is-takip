<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 py-4">
            <nav class="bg-white border-b border-gray-100 mx-6">
                    ...
                    <div class="flex justify-between w-full h-16">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('customer.index')"
            ...
            <!-- Page Heading -->
            <header class="flex justify-between items-center bg-white shadow p-4 mx-6" v-if="$slots.header">
                <!--Header-->
                <div v-if="$slots['header']" class="font-semibold text-2xl">
                    <slot name="header"></slot>
                </div>
                <!--Action Button-->
                <div v-if="$slots['action-buttons']">
